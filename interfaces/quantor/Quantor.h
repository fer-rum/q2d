...
namespace q2d {
  namespace quantor {
    ...
    public:
      ...
      //- Information
    public:
      char const *id()        const { return  quantor_id(); }
      char const *copyright() const { return  quantor_copyright(); }
      char const *version()   const { return  quantor_version(); }
    ...
    public:
      Result     sat()        const { return  quantor_sat(quantor); }
      int const *assignment() const { return  quantor_assignment(quantor); }
    };
  }
}
